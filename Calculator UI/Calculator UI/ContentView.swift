...
enum CalculatorButton: String {
    ...
    var backgroundColor: Color {
        ...
        case .equals, .plus, .minus, .divide, .multiply:
            return Color(#colorLiteral(red: 0.9598893523, green: 0.53402704, blue: 0.8386400342, alpha: 1))
        case .ac, .plusMinus, .percent:
            return Color(#colorLiteral(red: 0.721568644, green: 0.8862745166, blue: 0.5921568871, alpha: 1))
        default:
            return Color(#colorLiteral(red: 0.7054011226, green: 0.6535013318, blue: 0.8033717275, alpha: 1))
        }
    }
